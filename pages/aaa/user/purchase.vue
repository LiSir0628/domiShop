<template>
	<view class="container">
		<uni-nav-bar fixed left-icon="back" @clickLeft="back" background-color="#ffffff" color="#000000" title="Buy courses">
		</uni-nav-bar>
		<view class="content" v-if="isShow">
			<view class="lists" v-if="spLists.length > 0">
				<!-- <view class="list">
					<view class="courses">
						<image class="courses-logo" src="../../static/images/banner01.png"></image>
						<image class="courses-play" src="../../static/images/icon06.png"></image>
					</view>
					<view class="msg">
						<view class="name">Egg Baby Competition Time in Century in ...</view>
						<view class="people">XX万人已学</view>
						<view class="courses-msg">
							<view class="courses-time">共65课时</view>
							<view class="courses-price">
								$<text class="price">2000.25</text>
							</view>
						</view>
					</view>
				</view> -->
