<template>
	<view class="container">
		<uni-nav-bar fixed left-icon="back" @clickLeft="back" background-color="#ffffff" color="#000000" title="My Commission">
		</uni-nav-bar>
				...
				<view class="lists" v-for="item in spLists">
					...
					<view class="lists-content">
						...
						<view class="lists-des">
							<view class="lists-time">{{item.addtime}}</view>
							<view class="lists-earn" v-if="item.access">Earn $<text class="access">{{item.access}}</text></view>
							<view class="lists-earn" v-else>Earn $<text class="access">0.00</text></view>
						</view>
					</view>
				</view>
			</view>
